...
HD_PWD='D:/facultate/an2/ed/PROIECT/project_echipa2/project_echipa2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log medie.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source medie.tcl -notrace

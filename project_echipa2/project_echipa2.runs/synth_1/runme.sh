...
HD_PWD='D:/facultate/an2/ed/project_echipa2/project_echipa2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log medie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source medie.tcl
